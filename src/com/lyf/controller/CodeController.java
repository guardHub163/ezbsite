...
public class CodeController {
	...
	@ResponseBody
	public String YZCode(String code,HttpSession httpSession){
		String result="";
		String session=(String)httpSession.getAttribute("code"); 
		if(code.toLowerCase().equals(session.toLowerCase())){
			result = "{'result':true}";
		}
		else {
			result = "{'result':false}";
